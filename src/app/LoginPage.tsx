  ...
  return (
    <div className="flex flex-col min-h-screen bg-white items-center justify-start pt-8">
      ...
      <div className="flex flex-col items-center mb-8">
        <Image src="/logo.png" alt="Next Talent Logo" width={320} height={320} priority className="mb-4" />
      </div>
      ...
      <div className="w-full max-w-lg flex flex-col items-center">
        <form className="w-full">
          ...
          <div className="flex items-center mb-6">
            <input id="password" type="password" placeholder="" className="w-full px-4 py-2 bg-gray-100 text-gray-700 rounded-none border-0 border-b border-gray-300 focus:outline-none focus:ring-0 focus:border-blue-400 shadow-sm" />
            <button type="button" className="ml-2 px-4 py-2 bg-transparent text-gray-500 font-medium">Show</button>
          </div>
