    ...
    <div style={{ minHeight: '100vh', background: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center', paddingBottom: 80 }}>
      ...
      {selectedTab === 'staff' && (
        <div style={{ width: '100%', maxWidth: 500, marginTop: 18, background: 'white', borderRadius: 8, overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.04)' }}>
          ...
          <div style={{ background: '#222', color: 'white', fontWeight: 700, fontSize: 22, padding: '8px 0 8px 16px', borderTopLeftRadius: 8, borderTopRightRadius: 8 }}>COACHING STAFF</div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', background: 'white' }}>
              ...
              <tbody>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Bruno Lage</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Manager</div>
                  </td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Ricardo Rocha</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Assistant Manager</div>
                  </td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Luís Lage</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Assistant Manager</div>
                  </td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Carlos Cachada</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Assistant Manager</div>
                  </td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Gonçalo Simões</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Goalkeeping Coach</div>
                  </td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Nuno Santos</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Goalkeeping Coach</div>
                  </td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Alexandre Silva</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Conditioning Coach</div>
                  </td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Jhony Conceição</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Match Analyst</div>
                  </td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Diogo Camacho</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Match Analyst</div>
                  </td>
                </tr>
          ...
          <div style={{ maxHeight: 320, overflowY: 'auto', borderBottom: '8px solid #f0f0f0' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', background: 'white' }}>
              ...
              <tbody>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Lourenço de Andrade Pereira Coelho</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Head of Football Operations</div>
                  </td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Luisão</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Technical Director</div>
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          {/* BOARD OF DIRECTORS */}
          <div style={{ background: '#222', color: 'white', fontWeight: 700, fontSize: 22, padding: '8px 0 8px 16px', borderTopLeftRadius: 8, borderTopRightRadius: 8, marginTop: 18 }}>BOARD OF DIRECTORS</div>
          <div style={{ maxHeight: 320, overflowY: 'auto', borderBottom: '8px solid #f0f0f0' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', background: 'white' }}>
              <thead>
                <tr style={{ background: '#eee', color: '#222', fontWeight: 700, fontSize: 16 }}>
              ...
              <tbody>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Rui Costa</div>
                    <div style={{ color: '#222', fontSize: 15 }}>President</div>
                  </td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Nuno Gaioso</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Vice-Chairman</div>
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          {/* MEDICAL DEPARTMENT */}
          <div style={{ background: '#222', color: 'white', fontWeight: 700, fontSize: 22, padding: '8px 0 8px 16px', borderTopLeftRadius: 8, borderTopRightRadius: 8, marginTop: 18 }}>MEDICAL DEPARTMENT</div>
          <div style={{ maxHeight: 320, overflowY: 'auto', borderBottom: '8px solid #f0f0f0' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', background: 'white' }}>
              <thead>
                <tr style={{ background: '#eee', color: '#222', fontWeight: 700, fontSize: 16 }}>
              ...
              <tbody>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Ricardo Antunes</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Club Doctor</div>
                  </td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Paulo Rebelo</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Physiotherapist</div>
                  </td>
                </tr>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Pedro Barreira</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Physiotherapist</div>
                  </td>
                </tr>
              </tbody>
          ...
          <div style={{ maxHeight: 320, overflowY: 'auto', borderBottom: '8px solid #f0f0f0' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', background: 'white' }}>
              ...
              <tbody>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Ricardo Lemos</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Head of Media and Communications</div>
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          {/* KIT MANAGER */}
          <div style={{ background: '#222', color: 'white', fontWeight: 700, fontSize: 22, padding: '8px 0 8px 16px', borderTopLeftRadius: 8, borderTopRightRadius: 8, marginTop: 18 }}>KIT MANAGER</div>
          <div style={{ maxHeight: 320, overflowY: 'auto', borderBottom: '8px solid #f0f0f0' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', background: 'white' }}>
              <thead>
                <tr style={{ background: '#eee', color: '#222', fontWeight: 700, fontSize: 16 }}>
              ...
              <tbody>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Luís Alberto Santos</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Kit Manager</div>
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', background: 'white' }}>
              ...
              <tbody>
                <tr style={{ borderBottom: '1px solid #eee' }}>
                  <td style={{ padding: 10 }}>
                    <div style={{ fontWeight: 700, color: 'black', fontSize: 18 }}>Nuno Gaioso</div>
                    <div style={{ color: '#222', fontSize: 15 }}>Team Organiser</div>
                  </td>
                </tr>
                {/* Empty row for future additions */}
                <tr style={{ borderBottom: '1px solid #eee', height: 64 }}><td></td></tr>
              </tbody>
            </table>
          </div>
        ...
        <div style={{ width: '100%', maxWidth: 500, marginTop: 18, background: 'white', borderRadius: 8, overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.04)' }}>
          ...
          <div style={{ overflowX: 'auto', width: '100%' }}>
            <table style={{ minWidth: 900, width: '100%', borderCollapse: 'collapse', background: 'white' }}>
              ...
              <tbody>
                {staff.map((s, idx) => (
                  <tr key={idx} style={{ borderBottom: '1px solid #eee', color: '#222', fontSize: 17 }}>
